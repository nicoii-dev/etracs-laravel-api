...
class FaasController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'td_number' => 'required|unique:faas,td_number',
            'title_type' => 'required',
            'issue_date' => 'required',
        ...
        Faas::create([
            ...
            'barangay_lgu' => $request['barangay_lgu'],
            ...
            'actual_use_value' => $request['actual_use_value'],
            'land_adjustment_type' => $request['land_adjustment_type'],
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'transaction' => 'required',
            'revision_year' => 'required',
            'td_number' => 'required|unique:faas,td_number,'. $id .'id',
            'title_type' => 'required',
            'issue_date' => 'required',
            'effectivity' => 'required',
            'quarter' => 'required',
